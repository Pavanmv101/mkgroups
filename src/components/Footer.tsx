        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="mt-4 flex space-x-4">
              <a href="https://www.instagram.com/mkgroup_of_agriland_developers" target="_blank" rel="noreferrer" className="text-mk-gold hover:text-white transition-colors flex items-center text-sm font-medium">
              ...
              <a href="https://www.youtube.com/@mkagriprojects" target="_blank" rel="noreferrer" className="text-mk-gold hover:text-white transition-colors flex items-center text-sm font-medium">
                <svg className="w-5 h-5 mr-1" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
